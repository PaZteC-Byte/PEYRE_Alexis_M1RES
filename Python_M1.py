   ...
   "outputs": [
    {
     ...
     "output_type": "stream",
     "text": [
      "Veuillez rentrer votre prénom, nom et matricule d'étudiant séparés par des espaces : lele lele 111\n",
      "<class 'tuple'>\n"
     ]
    }
   ],
   ...
   "outputs": [
    {
     ...
     "output_type": "stream",
     "text": [
      "Veuillez rentrer votre prénom, nom et matricule d'étudiant séparés par des espaces :(Entrer 'FIN' pour finir la saisie)gALIPETTE TEST 444\n",
      "Veuillez rentrer votre prénom, nom et matricule d'étudiant séparés par des espaces :(Entrer 'FIN' pour finir la saisie)TEST JOLI 123\n",
      "Veuillez rentrer votre prénom, nom et matricule d'étudiant séparés par des espaces :(Entrer 'FIN' pour finir la saisie)je test 145\n",
      "Veuillez rentrer votre prénom, nom et matricule d'étudiant séparés par des espaces :(Entrer 'FIN' pour finir la saisie)je reteste 888\n",
   ...
   "outputs": [
    {
     ...
     "text": [
      ...
      "| Matricule : ele | Mme/Mr : lele lelel \n",
      "| Matricule : 122 | Mme/Mr : elel lele \n",
      "| Matricule : 141 | Mme/Mr : test je \n",
      "| Matricule : 444 | Mme/Mr : retest je \n",
      "| Matricule : 555 | Mme/Mr : test galipete \n",
      "| Matricule : 444 | Mme/Mr : TEST gALIPETTE \n",
      "| Matricule : 123 | Mme/Mr : JOLI TEST \n",
      "| Matricule : 145 | Mme/Mr : test je \n",
      "| Matricule : 888 | Mme/Mr : reteste je \n",
      "___________________________________________________\n"
     ]
    }
   ],
   ...
   "outputs": [
    {
     ...
     "output_type": "stream",
     "text": [
      "Entrer prenom, nom et matricule étudiant séparés par un espace : (FIN pour finir) Alexis peyre 11\n",
      "Entrer prenom, nom et matricule étudiant séparés par un espace : (FIN pour finir) thomas peyre 12\n",
      "Entrer prenom, nom et matricule étudiant séparés par un espace : (FIN pour finir) lea peyre 13\n",
      "Entrer prenom, nom et matricule étudiant séparés par un espace : (FIN pour finir) stephane peyre 14\n",
      "Entrer prenom, nom et matricule étudiant séparés par un espace : (FIN pour finir) virgignie peyre 15\n",
      "Entrer prenom, nom et matricule étudiant séparés par un espace : (FIN pour finir) rio peyre 16\n",
      "Entrer prenom, nom et matricule étudiant séparés par un espace : (FIN pour finir) FIN\n",
      "{'peyre': ('Alexis', 'peyre', '11'), 'peyre1': ('thomas', 'peyre', '12'), 'peyre2': ('lea', 'peyre', '13'), 'peyre3': ('stephane', 'peyre', '14'), 'peyre4': ('virgignie', 'peyre', '15'), 'peyre5': ('rio', 'peyre', '16')}\n"
     ]
    }
   ],
   "source": [
   ...
   "outputs": [
    {
     ...
     "output_type": "stream",
     "text": [
      "cle peyre1 valeur ('thomas', 'peyre', '12')\n"
     ]
    }
   ],
   "source": [
